...
(function() {
    ...
    function __alert(msg) {
        //$.inArray(“a”, divarr)==-1 msg.indexOf("成功")
        if(msg.search("成功")!=-1){
            msg = '<img src="resources/common/image/success.png" style="width: 30px;height: 30px;vertical-align: middle;margin-right:10px"/>'+msg;
        }else if(msg.search("失败")!=-1){
            msg = '<img src="resources/common/image/close.png" style="width: 30px;height: 30px;vertical-align: middle;margin-right:10px;"/>'+msg;
        }else{
            msg = '<img src="resources/common/image/tanhao.png" style="width: 30px;height: 30px;vertical-align: middle;margin-right:10px;"/>'+msg;
        }
            return __box({
                title: '',
                content: msg ,
